...
/***********************************************
primo - procura o número primo mais proximo ou igual a (n)
Parametros: n - numero a verificar
Retorno: (int) número primo mais proximo ou igual a (n)
Pre-condicoes: n > 0
***********************************************/
int primo(int n);
/***********************************************
verificaSeEPrimo - verifica se (n) é primo
Parametros: n - número a verificar
Retorno: 1 se (n) for primo 0 caso contrario.
Pre-condicoes: n > 0
***********************************************/
