...
/***********************************************
vetorDeEquipasEmJogo - cria um vetor de equipas em jogo.
Parametros:
	t - terreno 
	vetorEquipas - vetor estatico de equipas em jogo a preencher
Retorno: (void)
Pre-condicoes: t != NULL 
***********************************************/
equipa* vetorDeEquipasEmJogo(terreno t);
/***********************************************
ordenaEquipas - ordena o vetor de equipas colocando, da pior equipa á melhor.
Parametros:
	nEquipas - número de equipas em jogo 
